 ...
 *
 * Errors are wrapped in AiProviderError with a `transient` flag
 * so callers can decide whether to retry.  Raw SDK messages,
 * stacks, and errorDetails never leak into AiResult or logs.
 */
